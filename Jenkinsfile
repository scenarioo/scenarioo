...
def reportJenkinsSummary(summaryFile, contentHtml) {
    ...
    def contentCss = ""
    def overruleUglyPluginStyleCss = ".summary_report_table {border:none;margin:0px;padding:0px;border-spacing:0px;} .summary_report_table td {border:none;margin:0px;padding:0px;border-spacing:0px;}"
