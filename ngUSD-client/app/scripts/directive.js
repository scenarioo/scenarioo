...
NgUsdClientApp.directive('objecttolist', function ($filter) {
...
NgUsdClientApp.directive('sortandfilter', function ($compile) {
...
// Adrian: Do we need this later or can it be deleted?
