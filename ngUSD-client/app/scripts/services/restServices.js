...
angular.module('ngUSDClientApp.services').service('BranchService', function ($resource, $q, REST_API_URL) {
...
angular.module('ngUSDClientApp.services').service('UseCaseService', function ($resource, $q, REST_API_URL) {
...
angular.module('ngUSDClientApp.services').service('PageVariantService', function ($resource, $q, REST_API_URL) {
...
angular.module('ngUSDClientApp.services').service('ScenarioService', function ($resource, $q, REST_API_URL) {
...
angular.module('ngUSDClientApp.services').service('StepService', function ($resource, $q, REST_API_URL) {
...
angular.module('ngUSDClientApp.services').service('BuildStateService', function ($resource, $q, REST_API_URL) {
...
angular.module('ngUSDClientApp.services').service('AdminService', function ($resource, $q, REST_API_URL) {
