...
public class UserScenarioDocuFilesystem {
	...
	public Step loadStep(final String branchName, final String buildName, final String usecaseName,
		...
		String xmlFileName = StringUtils.leftPad(Integer.toString(stepIndex), 3, '0') + ".xml";
		File file = filePath(branchName, buildName, usecaseName,
				scenarioName, "steps", xmlFileName);
