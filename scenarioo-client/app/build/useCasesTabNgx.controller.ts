...
angular.module('scenarioo.controllers').controller('UseCasesTabNgxController', UseCasesTabNgxController);

function UseCasesTabNgxController($scope, $location, $filter, BranchesAndBuildsService, SelectedBranchAndBuildService,
