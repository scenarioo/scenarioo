...
export class LabelColorsComponent implements OnInit {
    ...
    loadLabelConfigurations() {
        this.labelConfigurationsListResource.query()
            .subscribe((labelConfigurations) => {
                labelConfigurations.push(LabelColorsComponent.createEmptyLabelConfiguration());
                this.labelConfigurations = labelConfigurations;
            });
    }

    static createEmptyLabelConfiguration() {
    ...
    addNewRow() {
        ...
        if (labelName !== '') {
            this.labelConfigurations.push(LabelColorsComponent.createEmptyLabelConfiguration());
        }
    }
