...
angular.module('scenarioo.controllers').controller('NavigationController', function ($scope, $location, LocalStorageService, FullTextSearchService, BranchesAndBuildsService, SelectedBranchAndBuildService, $uibModal, ApplicationInfoPopupService, ConfigService, GlobalHotkeysService) {
