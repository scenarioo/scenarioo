...
angular.module('scenarioo.controllers').controller('StepCtrl', function ($scope, $routeParams, $location, $q, $window, ConfigService, ScenarioResource, StepResource, HostnameAndPort,
