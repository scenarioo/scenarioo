...
useCase('Step - Screen Annotations')
    ...
    .describe(function () {
        ...
        scenario('Screen without annotations')
            ...
            .it(async function () {
                Utils.navigateToRoute('/step/Find Page/find_multiple_results/startSearch.jsp/0/0');
        ...
        scenario('Screen with annotations')
            ...
            .it(async function () {
                Utils.navigateToRoute('/step/Find Page/find_multiple_results/startSearch.jsp/0/1');
                stepPage.assertScreenshotIsShown();
        ...
        scenario('Popup')
            ...
            .it(async function () {
                Utils.navigateToRoute('/step/Technical%20Corner%20Cases/dummy_scenario_with_screen_annotations_of_all_types_on_one_page/specialPageWithOnlyOneVariant.jsp/0/1');
                stepPage.assertScreenshotIsShown();
