...
EditorPage.prototype.enterSketchInformation = function (sketchName) {
    this.issueNameTextField.sendKeys(sketchName);
    this.issueAuthorTextField.sendKeys(this.AUTHOR);
...
EditorPage.prototype.assertAuthorFieldIsFilledAlready = function () {
    expect(this.issueAuthorTextField.getAttribute('value')).toBe(this.AUTHOR);
};
