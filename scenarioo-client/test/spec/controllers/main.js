...
describe('Controller: MainCtrl', function () {
    ...
    it('loads usecases when branch and build selection changes', function() {
        var USECASES_URL = HostnameAndPort.forNgResource() + '/scenarioo/rest/branches/release-branch-2014-01-16/builds/example-build/usecases';
        var BRANCHES_URL = HostnameAndPort.forNgResource() + '/scenarioo/rest/branches';
