...
describe('BreadcrumbsService', function () {
    ...
    function expectStepIsNotMadeHumanReadable(navigationElements) {
        expect(navigationElements[1].label).toEqual('<strong>Step:</strong> search_results/0/1');
    }

    function expectFeatureAndScenarioAreHumanReadable(navigationElements) {
        expect(navigationElements[0].label).toEqual('<strong>Scenario:</strong> Search Book That Does Not Exist');
    }
