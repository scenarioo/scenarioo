...
public enum BuildRun {
	...
	APRIL(EXAMPLE_BRANCH_NAME_DEV, "2014-04-19", "F398DA3" /* no status set to test status calculation based on scenarios */),
	MAY(EXAMPLE_BRANCH_NAME_DEV, "2014-05-19", "F398DA3" /* no status set to test status calculation based on scenarios */);
	 ...
	 * statuses.
	 */
	private BuildRun(final String branchName, final String date, final String revision) {
		this(branchName,date, revision, null);
	}

	private BuildRun(final String branchName, final String date, final String revision, final Status status) {
