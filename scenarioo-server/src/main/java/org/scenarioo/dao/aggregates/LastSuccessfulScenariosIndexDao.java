...
public class LastSuccessfulScenariosIndexDao {
	...
	public LastSuccessfulScenariosIndexDao(final File dataDirectory, final String branchName) {
		lastSuccessfulScenariosBuildIndexFile = new File(dataDirectory, /*TODO FIX ENCODING*/FilesUtil.encodeName(branchName) + "/"
				+ FilesUtil.encodeName(LastSuccessfulScenariosBuildUpdater.LAST_SUCCESSFUL_SCENARIO_BUILD_NAME) + "/"
				+ FilesUtil.encodeName(LAST_SUCCESSFUL_SCENARIOS_INDEX_FILENAME));
	}
