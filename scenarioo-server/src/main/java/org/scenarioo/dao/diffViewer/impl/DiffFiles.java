...
public class DiffFiles {
	...
	public File getFeatureDirectory(final String baseBranchName, final String baseBuildName,
		...
		return new File(getComparisonDirectory(baseBranchName, baseBuildName, comparisonName),
				FilesUtil.encodeName(featureName));
	}

	public File getFeatureFile(final String baseBranchName, final String baseBuildName,
							   final String comparisonName, final String featureName) {
		return new File(getFeatureDirectory(baseBranchName, baseBuildName, comparisonName, featureName),
				FILE_NAME_FEATURE);
	}

	public List<File> getFeatureFiles(final String baseBranchName, final String baseBuildName,
			final String comparisonName) {
		return FilesUtil.getListOfFilesFromSubdirs(
				getComparisonDirectory(baseBranchName, baseBuildName, comparisonName), FILE_NAME_FEATURE);
	}
	...
	public File getScenarioDirectory(final String baseBranchName, final String baseBuildName,
		...
		return new File(
				getFeatureDirectory(baseBranchName, baseBuildName, comparisonName, featureName),
	...
	public File getScenarioFile(final String baseBranchName, final String baseBuildName,
			final String comparisonName, final String featureName,
			final String scenarioName) {
		return new File(getScenarioDirectory(baseBranchName, baseBuildName, comparisonName, featureName, scenarioName),
				FILE_NAME_SCENARIO);
	}
	...
	public File getStepFile(final String baseBranchName, final String baseBuildName,
		...
		return new File(getStepsDirectory(baseBranchName, baseBuildName, comparisonName, featureName, scenarioName),
	...
	public List<File> getStepFiles(final String baseBranchName, final String baseBuildName,
			final String comparisonName, final String featureName,
			final String scenarioName) {
		return FilesUtil.getListOfFiles(getStepsDirectory(baseBranchName, baseBuildName, comparisonName, featureName,
				scenarioName));
	}
	...
	public File getScreenshotFile(final String baseBranchName, final String baseBuildName,
			final String comparisonName,
			final String featureName, final String scenarioName, final String imageName) {
		return new File(getScreenshotsDirectory(baseBranchName, baseBuildName, comparisonName, featureName,
				scenarioName),
				imageName);
	}
