...
public class ScreenshotResponseFactory {
	...
	public Response createResponse(final SketchStepLoaderResult stepLoaderResult, final boolean showFallbackStamp,
	...
	private Response foundImageResponse(final SketchStepLoaderResult steLoaderResult, final boolean showFallbackStamp) {
