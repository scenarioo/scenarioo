...
@Path("/rest/branch/{branchName}/build/{buildName}/feature/{featureName}/scenario/{scenarioName}/pageName/{pageName}/pageOccurrence/{pageOccurrence}/stepInPageOccurrence/{stepInPageOccurrence}")
