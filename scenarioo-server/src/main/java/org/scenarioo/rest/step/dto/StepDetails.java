...
public class StepDetails {
	...
	public StepDetails(final StepIdentifier stepIdentifier, final boolean fallback, final Step step,
			final StepNavigation stepNavigation, final StepStatistics stepStatistics, final Labels featureLabels,
	...
	public Labels getFeatureLabels() {
		return featureLabels;
	}

	public void setFeatureLabels(final Labels featureLabels) {
		this.featureLabels = featureLabels;
	}
