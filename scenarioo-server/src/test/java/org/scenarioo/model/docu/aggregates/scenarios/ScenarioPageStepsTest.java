...
public class ScenarioPageStepsTest {
	...
	private PageSteps createPageStepsWithNumberOfSteps(final int numberOfSteps,
	...
	private List<StepDescription> createStepsListWithNumberOfSteps(
	...
	private void whenGettingTotalStepsForPage1SecondOccurrence() {
		total = scenarioPageSteps.getTotalNumberOfStepsInPageOccurrence(
				"page1", 1);
	}
	...
	private void expectTotalNumberOfStepsInPageOccurrenceInStatisticsEquals(
			final int i) {
	}

	private void expectTotalNumberOfPagesInScenarioInStatisticsEquals(
			final int i) {
