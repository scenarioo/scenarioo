...
class SvgSanitizerTest {
	...
	@Test
	void sanitize_withTwoXmlns_RemovesSuperfluousXmlns(){
	...
	@Test
	void sanitize_withTwoXmlnsInImageTagAndOneInSvgTag_RemovesSuperfluousXmlnsInImageTag() {
	...
	@Test
	void sanitize_withSingleXmlns_DoesNotModifySVG(){
		String expectedSVG = "<svg height=\"1000\" width=\"1583\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" encoding=\"utf-8\" style=\"overflow: visible;\" id=\"SvgjsSvg1068\"><image xmlns:xlink=\"http://www.w3.org/1999/xlink\" xlink:href=";
	...
	@Test
	void sanitize_withNS1_RemovesNS1(){
	...
	@Test
	void sanitize_withoutNS1_DoesNotModifySVG(){
