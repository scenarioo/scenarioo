...
public class StepIndexResolverTest {
	...
	private final ScenarioIdentifier FEATURE_IDENTIFIER = new ScenarioIdentifier(BUILD_IDENTIFIER, "scenario",
			"feature");
	...
	private void givenStepIdentifierOfAnExistingStep() {
		stepIdentifier = new StepIdentifier(FEATURE_IDENTIFIER, StepTestData.PAGE_NAME_VALID_1, 1, 2);
	}

	private void givenStepIdentifierWhereStepInPageOccurrenceDoesNotExist() {
		stepIdentifier = new StepIdentifier(FEATURE_IDENTIFIER, StepTestData.PAGE_NAME_VALID_1, 1, 3);
	}
	...
	private void givenStepWherePageOccurrenceDoesNotExist() {
		stepIdentifier = new StepIdentifier(FEATURE_IDENTIFIER, StepTestData.PAGE_NAME_VALID_1, 2, 3);
	}
	...
	private void givenStepWithPageThatDoesNotExistInScenario() {
		stepIdentifier = new StepIdentifier(FEATURE_IDENTIFIER, StepTestData.PAGE_NAME_NON_EXISTENT, 0, 0);
	}
