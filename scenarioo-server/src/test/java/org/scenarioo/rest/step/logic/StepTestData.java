...
public class StepTestData {
	...
	public static final String LABEL_FEATURE = "security";
	...
	public static final String FEATURE_NAME_VALID = "Find the answer";
	public static final String FEATURE_NAME_VALID_WITH_MATCHING_LABELS = "Login";
	public static final String FEATURE_NAME_INEXISTENT = "Some inexistent feature";
	...
	public static final ScenarioIdentifier SCENARIO_IDENTIFIER_VALID = new ScenarioIdentifier(BUILD_IDENTIFIER_VALID,
			FEATURE_NAME_VALID, SCENARIO_NAME_VALID);
	public static final ScenarioIdentifier SCENARIO_IDENTIFIER_VALID_2 = new ScenarioIdentifier(BUILD_IDENTIFIER_VALID,
			FEATURE_NAME_VALID, SCENARIO_NAME_VALID_2);
	public static final ScenarioIdentifier SCENARIO_IDENTIFIER_LOGIN_WITH_MATCHING_LABELS = new ScenarioIdentifier(
			BUILD_IDENTIFIER_VALID, FEATURE_NAME_VALID_WITH_MATCHING_LABELS, SCENARIO_NAME_VALID_WITH_MATCHING_LABELS);
	public static final ScenarioIdentifier SCENARIO_IDENTIFIER_FALLBACK_WITH_LABELS_IN_SAME_FEATURE = new ScenarioIdentifier(
			BUILD_IDENTIFIER_VALID, FEATURE_NAME_VALID, SCENARIO_NAME_VALID_WITH_MATCHING_LABELS);
	public static final ScenarioIdentifier SCENARIO_IDENTIFIER_INEXISTENT_SCENARIO = new ScenarioIdentifier(
			BUILD_IDENTIFIER_VALID, FEATURE_NAME_VALID, SCENARIO_NAME_INEXISTENT);
	public static final ScenarioIdentifier SCENARIO_IDENTIFIER_INEXISTENT_FEATURE = new ScenarioIdentifier(
			BUILD_IDENTIFIER_VALID, FEATURE_NAME_INEXISTENT, SCENARIO_NAME_VALID);
	...
	public static final StepIdentifier STEP_IDENTIFIER_INEXISTENT_FEATURE = new StepIdentifier(
			SCENARIO_IDENTIFIER_INEXISTENT_FEATURE, PAGE_NAME_VALID_1, 0, 0);
	public static final StepIdentifier STEP_IDENTIFIER_INEXISTENT_FEATURE_WITH_LABELS = new StepIdentifier(
			SCENARIO_IDENTIFIER_INEXISTENT_FEATURE, PAGE_NAME_VALID_1, 23, 443, LABELS_FOR_STEP_IDENTIFIER);

	// scenario data
	public static final ScenarioPageSteps SCENARIO = createScenarioPagesAndSteps();
	public static final ScenarioPageSteps SCENARIO_FALLBACK_IN_SAME_FEATURE = createFallbackScenarioPagesAndSteps();
	...
	private static ObjectTreeNode<ObjectReference> createReferenceTreePage1() {
		...
		node.addChild(createFeatureNode());
		node.addChild(createFeatureNodeWithMatchingLabel());
		return node;
	}

	private static ObjectTreeNode<Object> createFeatureNode() {
		ObjectTreeNode<Object> node = new ObjectTreeNode<Object>();
		node.setItem(objectReference(TYPE_FEATURE, FEATURE_NAME_VALID));
		node.addChild(createScenarioNodeWithDifferentScenario());
		node.addChild(createScenarioNodeWithMatchingLabels());
		return node;
	}

	private static ObjectTreeNode<?> createFeatureNodeWithMatchingLabel() {
		ObjectTreeNode<Object> node = new ObjectTreeNode<Object>();
		node.setItem(objectReference(TYPE_FEATURE, FEATURE_NAME_VALID_WITH_MATCHING_LABELS));
		node.addChild(createScenarioNodeWithMatchingLabels());
		node.getDetails().addDetail("labels", createLabelsForObjectIndex(LABEL_FEATURE));
		return node;
	}
